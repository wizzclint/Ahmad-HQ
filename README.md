...
| Tab | What it holds |
|---|---|
| `HQ_EDIBLE_WEEKLY` | One row per week ending: net sales, sales target, orders, labor hours and cost, add-on orders, refunds, voids, and sales by channel (direct store, corporate, online). Raw numbers only |
...
- **Sales by channel.** The week form has three boxes: direct store, corporate and online sales. Type any two and the third is worked out from net sales (type all three and they are checked against it), and the form shows each channel's share of net sales and its change from last week as you type. The KPIs tab has a "Sales by channel" table for the week being viewed: dollars, % of net sales, the change since the entry before it (dollars, percent and percentage points), the target share from the "Direct Sales %" and "Online Sales Mix" rows, and the corporate-vs-direct gap, with the last eight weeks in a fold-out. Weeks entered the old way (one "Corporate / Online Sales" figure) still work: direct is net sales minus that figure, and corporate + online stay together until someone types them separately. The entry checks point out channels that don't add up to net sales and a jump of 15+ points in the direct share. The Summary shows the shares too, and a saved wrap-up keeps the mix.
